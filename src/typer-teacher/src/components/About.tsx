...
useEffect(() => {
    document.title = "Typer Teacher - About";
    });
...
return (
    ...
    <Row>
      <h1>About Page</h1>
      <p>
        Typer Teacher is an open-source web application that caters towards visually-impaired people to assist in teaching them how to touch-type.
      </p>
    </Row>
    <Row>
      <h2>FAQ</h2>
    ...
    <Row>
      <Accordion defaultActiveKey="0">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            <p>
              This application is absolutely free, entirely open-source, and will always remain so. The source code for the application is available on GitHub <a href="https://github.com/MichaelMale/typer-teacher">here</a>.
            </p>
            <p>
